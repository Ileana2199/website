...
if(isset($_GET['txtID'])){
    ...
    if($_POST){
      ...
      if($password==""){
        ...
        SET usuario=:usuario,correo=:correo WHERE id=:id");
        ...
        $sentencia=$conexion->prepare("UPDATE tbl_usuarios
        SET usuario=:usuario,password=:password,correo=:correo WHERE id=:id");
...
<div class="card">
      ...
      <div class="mb-3">
        <label for="password" class="form-label">Password:dejar vacio si no se quiere cambiar</label>
        <input type="password"
          class="form-control"  value="" name="password" id="password" aria-describedby="helpId" placeholder="Password">
      </div>
      <div class="mb-3">
